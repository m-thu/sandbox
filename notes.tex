...
Resistivity ($\vec E$: electric field, $[|\vec E|]=\nicefrac{\mathrm{V}}{\mathrm{m}}$, $\vec j$: current density, $[|\vec j|]=\nicefrac{\mathrm{A}}{\mathrm{m}^2}$):
\[
...
Conductivity:
\[
	\sigma\equiv\kappa=\frac{1}{\varrho},\quad[\sigma]=\frac{\mathrm{S}}{\mathrm{m}}\equiv\frac{\mathrm{mho}}{\mathrm{m}}\equiv\frac{\mho}{\mathrm{m}}
\]
...
\[
	\bar{\vec v}=-\frac{1}{m_\mathrm{e}}\cdot e\tau\cdot\vec E\,\curvearrowright\,\vec j=\frac{ne^2\tau}{m_\mathrm{e}}\cdot\vec E
\]
...
\textbf{AC electrical conductivity}
